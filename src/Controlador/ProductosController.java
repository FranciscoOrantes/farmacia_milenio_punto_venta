...
public class ProductosController implements Initializable {
    ...
    public static String codigo, nombre, descripcion, presentacion, sustancia, tipo, rubro, proveedor;
    ...
    public void seleccionProducto() {
        ...
        id = producto.getId();
        nombre = producto.getNombreT();
        codigo = producto.getCodigoT();
        presentacion = producto.getPresentacionT();
        descripcion = producto.getDescripcionT();
        sustancia = producto.getSustanciaT();
        tipo = producto.getTipoT();
        rubro = producto.getRubroT();
